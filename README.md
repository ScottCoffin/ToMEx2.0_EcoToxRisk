...
* **Source toxicity database:**
  [https://github.com/SCCWRP/ToMEx_AquaticOrganisms](https://github.com/SCCWRP/ToMEx_AquaticOrganisms)
...
Download pre-computed Monte Carlo and PSSD++ outputs from Zenodo:
[https://doi.org/10.5281/zenodo.16740504](https://doi.org/10.5281/zenodo.16740504)
...
* **Zenodo archive:** [https://doi.org/10.5281/zenodo.16740504](https://doi.org/10.5281/zenodo.16740504)
* **Key directories:**
...
> Coffin, S., Bertrand, L., Ahmed, K. T., de Souza Leite, L., Cowger, W., Siña, M., Barrick, A., Kukkola, A., Carney Almroth, B., Miller, E., Yeh, A., LaPlaca, S. B., & Mair, M.
A Probabilistic Risk Framework for Microplastics Integrating Uncertainty Across Toxicological and Environmental Variability: Development and Application to Marine and Freshwater Ecosystems.
Journal of Hazardous Materials (in review).
Preprint available at: https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5440537
