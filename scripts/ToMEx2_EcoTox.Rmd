...
aoc_risk_paper <- aoc_aligned_no_filters %>% 
  drop_na(effect.metric) %>% 
  filter(!environment %in% c("Terrestrial", "Not Reported"),
         Group != "Bacterium",
         Group != "Plant",
...
aoc_tech_only <- aoc_aligned_no_filters %>% 
  drop_na(effect.metric) %>% 
  filter(!environment %in% c("Terrestrial", "Not Reported"),
         Group != "Bacterium",
         Group != "Plant",
...
aoc_risk_only <- aoc_aligned_no_filters %>% 
  drop_na(effect.metric) %>% 
  filter(!environment %in% c("Terrestrial", "Not Reported"),
         Group != "Bacterium",
         Group != "Plant",
...
summary_stats_base_thresholds <- readRDS("monte carlo/output/summary_stats_base_thresholds.rds")
```
