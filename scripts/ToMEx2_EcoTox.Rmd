...
myt <- t2 %>%
  filter(Species == "Mytilus galloprovincialis")
>>>>>>> 102b578c12f83c99ce8213082bc8e9aba2beeb6c
...
=======
hist(log10(NOEC2_t1_volume[4,]), freq = F, main = "Ceriodaphnia dupia - 14 endpoints", xlab = "NOEC log[particles/L]")
# probability density
lines(density(log10(NOEC2_t1_volume[4,])), col = "red", lwd = 2) 
# Deterministic NOEC
abline(v = median(log10(NOEC.det2_t1_volume[4]), na.rm = TRUE), col = "green", lty = 2, lwd = 2)
>>>>>>> 102b578c12f83c99ce8213082bc8e9aba2beeb6c
```
