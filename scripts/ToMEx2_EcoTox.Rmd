...
dataframe_names <- c("formatted_thresholds", "simple_thresholds_MC", "simple_thresholds_MC_mass", "MC_RSD",
                     "PNEC_summary_table_wide",
                     "freshwater_marine_params_species_sensitivity_analysis",
                     "unified_thresholds", "leave_one_out_df", "tomex2.0_aoc_z_final_utf8")

# Corresponding custom sheet names
sheet_names <- c("Deterministic_thresholds", "Monte_Carlo_thresholds", "Monte_Carlo_thresholds_mass", "Monte_Carlo_RSD", 
                 "PSSD++PNEC_summary",
