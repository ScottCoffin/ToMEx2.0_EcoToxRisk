...
cov_results <- results_df %>%
  group_by(rowid) %>%
  summarise(
    CoV_ox_stress = sd(particles_L_ox_stress, na.rm = TRUE) / mean(particles_L_ox_stress, na.rm = TRUE),
    CoV_food_dilution = sd(particles_L_food_dilution, na.rm = TRUE) / mean(particles_L_food_dilution, na.rm = TRUE)
  )
