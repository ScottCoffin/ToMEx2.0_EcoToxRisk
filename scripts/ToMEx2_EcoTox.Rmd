...
ggplot() +
  # pSSD PNECs
  geom_histogram(data = pSSD_PNECs, aes(x = PNEC, y = ..density.., fill = "pSDD++"), 
                 color = "coral", bins = 350, alpha = 0.5) +
  geom_density(data = pSSD_PNECs, aes(x = PNEC, color = "pSDD++"), lwd = 1) +  # Density line for pSDD++
  
  # MC-SSD PNECs
  geom_histogram(data = MC_PNECs, aes(x = PNEC, y = ..density.., fill = "MC-SSD"), 
                 color = "lightblue", bins = 350, alpha = 0.5) +
  geom_density(data = MC_PNECs, aes(x = PNEC, color = "MC-SSD"), lwd = 1) +  # Density line for MC-SSD
  ...
  scale_fill_manual(name = "Method", 
                    values = c("pSDD++" = "coral", "MC-SSD" = "lightblue")) +
