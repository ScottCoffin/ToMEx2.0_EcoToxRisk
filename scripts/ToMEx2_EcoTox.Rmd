...
# prep_data() function scripted in utils/functions.R
# #example usage
...
### Run PSSD
```{r include=FALSE}
# run_pSSD_analysis() function scripted in utils/functions.R
...
```{r}
# prepare_plot_data function scripted in utils/functions.R
...
```{r}
# generate_color_palette function and pSSD_plot_fnx functions scripted in utils/functions.R
...
```{r}
# make_PNEC_plot function scripted in utils/functions.R
...
#### PNEC Data Summary
```{r}
# PNEC_data_summary function scripted in utils/functions.R
...
```{r}
# generate_plots_and_summary() function scripted in utils/funcitons.R
```

##### Dataset mapping
```{r}
# get_results_df() function scripted in utils/functions.R
```
