...
# 
# bodysize_addons_ShinyUpdate <- readRDS("../data/input/gape_size_list.RDS") %>% 
#   ungroup()
```

Check to see if bodysize lists are identical
```{r}
# bodysize_addons_ShinyUpdate %>% 
#   distinct(Species, life_f, body.length.cm) %>% 
#   arrange(Species)
```
```{r}
# aoc_z %>% 
#   left_join(bodysize_addons_ShinyUpdate, 
#             by = c("Species", "life_f", "doi"))
```
```{r}
# body_size_final <- aoc_z %>%  
#   distinct(doi, Species, life_f, body.length.cm, body.size.source)
```
...
# just_used_data_all_tiers <- left_join(
#   tiers1_2_used,
#   tiers3_4_used,
#   by = "rowid"
#   ) %>% 
#   mutate(thresholds3_4 = case_when(
#     is.na(thresholds3_4) ~ "Does not meet criteria",
#     T ~ thresholds3_4
#   ))
# 
# just_used_data_all_tiers %>% 
#   select(environment, thresholds1_2, thresholds3_4)
```
...
#write.csv(data_used_thresholds_summary, "../data/output/data_used_thresholds_summary.csv")
...
write.csv(simple_thresholds_MC_mass,
          "output/simple_thresholds_MC_mass.csv")
...
write.csv(simple_thresholds_MC_meta,
          "output/simple_thresholds_table_meta.csv")
