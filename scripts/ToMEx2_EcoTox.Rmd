...
min_diff <- min(leave_one_out_df$diff, na.rm = TRUE) * 0.7  # Add some padding
max_diff <- max(leave_one_out_df$diff, na.rm = TRUE) * 1.3  # Add some padding
...
#  geom_histogram() +
 ...
 # geom_line() +
  ...
  scale_x_continuous(trans = pseudo_log_trans(base = 10), 
                       breaks = c(-10, 0, 1, 10, 40),  # Values correspond to -10%, 0%, 100%, 1000%, and 4000%
