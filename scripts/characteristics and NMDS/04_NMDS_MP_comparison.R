#### NMDS analysis of microplastic characteristics comparing marine and freshwater samples ####
#### Creates Figure 3 in main manuscript ####
...
dat = read.csv(
     "data/input/characteristics and NMDS/data_comp_to_env_compiled.csv",
