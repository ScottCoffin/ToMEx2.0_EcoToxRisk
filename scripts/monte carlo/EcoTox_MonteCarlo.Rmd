...
param_default_values <- data.frame(
  ...
  R.ave.water.marine.sd = R.ave.water.marine.sd,
  R.ave.water.freshwater = R.ave.water.freshwater,
  R.ave.water.freshwater.sd = R.ave.water.freshwater.sd,
  R.ave.sediment.marine = R.ave.sediment.marine,
  R.ave.sediment.marine.sd = R.ave.sediment.marine.sd,
  R.ave.sediment.freshwater = R.ave.sediment.freshwater,
  R.ave.sediment.freshwater.sd = R.ave.sediment.freshwater.sd,
  p.ave.marine = p.ave.marine,
  p.ave.marine.sd = p.ave.marine.sd,
  alpha.marine = alpha.marine,
  alpha.marine.sd = alpha.marine.sd,
  a.sa.marine = a.sa.marine,
  a.sa.marine.sd = a.sa.marine.sd,
  a.v.marine = a.v.marine,
  a.v.marine.sd = a.v.marine.sd,
  a.m.marine = a.m.marine,
  a.m.marine.sd = a.m.marine.sd,
  a.ssa.marine = a.ssa.marine,
  a.ssa.marine.sd = a.ssa.marine.sd,
  p.ave.freshwater = p.ave.freshwater,
  p.ave.freshwater.sd = p.ave.freshwater.sd,
  alpha.freshwater = alpha.freshwater,
  alpha.freshwater.sd = alpha.freshwater.sd,
  a.sa.freshwater = a.sa.freshwater,
  a.sa.freshwater.sd = a.sa.freshwater.sd,
  a.v.freshwater = a.v.freshwater,
  a.v.freshwater.sd = a.v.freshwater.sd,
  a.m.freshwater = a.m.freshwater,
  a.m.freshwater.sd = a.m.freshwater.sd,
  a.ssa.freshwater = a.ssa.freshwater,
  a.ssa.freshwater.sd = a.ssa.freshwater.sd,
  beta_log10_body_length = beta_log10_body_length,
  se_beta_log10_body_length = se_beta_log10_body_length,
  body_length_intercept = body_length_intercept,
  se_body_length_intercept = se_body_length_intercept,
  beta_0 = beta_0,
  se_beta_0 = se_beta_0,
  beta_1 = beta_1,
  se_beta_1 = se_beta_1
...
# scripted in utils/functions.R
# test
aligned_data_test <- align_data(aoc_risk_paper)
aligned_data_test %>% select(particles.mL.ox.stress, particles.mL.food.dilution) %>% head()
```
...
```{r}
# model_wrapper_sobol_parallel scripted in utils/functions.R
```

### Define Matrix
```{r include=FALSE}
# matrix_function() defined in utils/functions.R

# Number of samples
n_sobol <- 589 #times 16 is 9,424  

mat <- matrix_function(n_sobol = n_sobol, params = param_default_values, upper.tissue.truncation.limit = 500)
...
#### Histograms
```{r}
# generate plots for parameter histograms
parameter_histograms <- parameter_histograms_function(mat)
tissue_body <- parameter_histograms$tissue_body
alpha_combined_plot <- parameter_histograms$alpha_combined_plot
### Display Plots
tissue_body
alpha_combined_plot
