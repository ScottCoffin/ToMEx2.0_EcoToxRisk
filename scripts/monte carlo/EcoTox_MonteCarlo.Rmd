...
<!-- model_wrapper <- function(params, iteration, MC_results_name, simulation_id){ -->
...
<!-- aoc_MC_iter <- align_data(aoc_risk_paper, -->
...
<!-- saveRDS(n_sim, "output/n_sim.rds") -->
<!-- ``` -->
...
<!--                       .options.snow = opts, -->
<!--                       .combine = rbind, -->
<!--                       .export = c("model_wrapper", "aoc_aligned", #"ToMEx1.0fxn", "ToMEx2.0fxn", -->
<!--                                   "align_data", -->
...
<!--                                   "volumefnx", "SAfnx", "massfnx",  "mux_polyfnx", "CFfnx", -->
<!--                                   "MC_results_parallel", -->
<!--                                   "n_sim", -->
...
<!--   H_W_ratio_marine <- as.numeric(params$H_W_ratio.marine[1]) -->
<!--   R_ave_water_freshwater <- as.numeric(params$R.ave.water.freshwater[1]) -->
<!--   H_W_ratio_freshwater <- as.numeric(params$H_W_ratio.freshwater[1]) -->
...
<!--                         MC_results_parallel[[i]] <- model_wrapper(params, -->
<!--                                                                   i, -->
...
<!-- # Uncomment if running. Otherwise, keep commented out to avoid overwriting -->
<!-- ``` -->
...
<!-- ```{r include=FALSE} -->
<!-- ### Generate plots -->
<!-- MC_histograms_marine <- MC_histograms_fxn(all_thresholds_long,  -->
<!--                                           "Marine", -->
<!--                                           n_bins = round(n_sim *0.8), -->
<!--                                         #  units_input = "ug/L", -->
...
<!--               select(af.noec, af.time, unique_id) %>%  -->
<!--               mutate(unique_id = as.factor(unique_id)), -->
<!--             by = "unique_id" -->
<!--             ) -->
