...
thresholds_df %>% 
  ...
  mutate(tissue_translocation_ug.L =  `Tissue Translocation (Default)` *mux_polyfnx_generalizable(
...
Deterministic threshold dataset 
```{r}
...
```{r}
n_sim <- 100 #10 for beta-testing, 1000 for full 
