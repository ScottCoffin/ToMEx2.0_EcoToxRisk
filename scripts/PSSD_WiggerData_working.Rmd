...
```
--
This script uses Wigger et al data, and is intended to serve as a proof-of-concept that the modified code works on their data and produces identical results. Use the ToMEx version of this script for ToMEx data.
