...
tier1_2_large.obs <- tier1_2_large %>% summarize(n.obs = n(), n.studies = n_distinct(doi), n.taxa = n_distinct(Group), n.species = n_distinct(species_f))
...
# Count observations and studies
tier1_2_small.obs <- tier1_2_small %>% summarize(n.obs = n(), n.studies = n_distinct(doi), n.taxa = n_distinct(Group), n.species = n_distinct(species_f))
```
...
# Count observations and studies
tier3_4_large.obs <- tier3_4_large %>% summarize(n.obs = n(), n.studies = n_distinct(doi), n.taxa = n_distinct(Group), n.species = n_distinct(species_f))
...
# Count observations and studies
tier3_4_small.obs <- tier3_4_small %>% summarize(n.obs = n(), n.studies = n_distinct(doi), n.taxa = n_distinct(Group), n.species = n_distinct(species_f))
```
...
study_list_fooddilution_1_2 <-tier1_2_large %>% 
  select(doi, authors, Group, species_f, lvl1_f, lvl3_f, bio_f, effect.metric, acute.chronic_f, shape_f, poly_f,
...
##### Build functions ####
source("scripts/EcoTox/PSSD/rmore.r")
source("scripts/EcoTox/PSSD/do.pssd.r")
