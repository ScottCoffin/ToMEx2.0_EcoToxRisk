...
# import data
dat = readRDS("Data/aoc_z_tomex2.RDS")
str(dat)
...
dat = dat %>% select(env_f, 
               poly_f, shape_f, particle.surface.area.um2, size.length.mm.nominal, size.width.mm.nominal,
               density.g.cm3)
...
dat$poly_f[dat$poly_f %in% c("Biopolymer", "Not Reported", "Polycarbonate", "Polyethylene vinyl acetate",
                             ...
                             "Poly(Styrene-co-acrylonitrile)", "Polyamidoamine", "Polyoxymethylene", "Polytetrafluoroethylene",
...
dat$poly_f[dat$poly_f %in% c("High Density Polyethylene", "Low Density Polyethylene", "Medium Density Polyethylene")] = "Polyethylene"
